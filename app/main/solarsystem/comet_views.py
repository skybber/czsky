...
def comet_visibility(comet_id):
    ...
    rise_transit_set = get_rise_transit_set_utc(
        ...
        ra=comet.cur_ra,
        dec=comet.cur_dec,
        object_label=comet.designation
    )
...
def _do_redirect(url, comet, splitview=False, fullscreen=False):
    ...
    return redirect(url_for(url, comet_id=comet.comet_id, back=back, back_id=back_id, fullscreen=fullscreen, splitview=splitview, embed=embed, season=season, dt=dt))
