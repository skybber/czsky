...
from app.commons.dso_description_utils import get_dso_descriptions
...
def deepskyobject_info(dso_id):
    ...
    if not user_descr and not apert_descriptions and not title_img and dso != orig_dso:
        user_descr, apert_descriptions, title_img = get_dso_descriptions(orig_dso)
...
def deepskyobject_observation_log(dso_id):
    ...
    _, apert_descriptions, _  = get_dso_descriptions(dso)
