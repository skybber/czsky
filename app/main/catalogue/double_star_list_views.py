...
@main_double_star_list.route('/double_star-list/<string:double_star_list_id>/chart', methods=['GET', 'POST'])
def double_star_list_chart(double_star_list_id):
    ...
    double_star_id = request.args.get('double_star_id')
    double_star_list_item = None
    if double_star_id and double_star_id.isdigit():
        idouble_star_id = int(double_star_id)
        double_star_list_item = next((x for x in double_star_list.double_star_list_items if x.double_star.id == idouble_star_id), None)
    ...
    if not common_ra_dec_fsz_from_request(form):
        if form.ra.data is None or form.dec.data is None:
            form.ra.data = double_star_list_item.double_star.ra if double_star_list_item else 0
            form.dec.data = double_star_list_item.double_star.dec if double_star_list_item else 0
    ...
    return render_template('main/catalogue/double_star_list_info.html', fchart_form=form, type='chart', double_star_list=double_star_list,
                           double_star_list_descr=double_star_list_descr, chart_control=chart_control)


@main_double_star_list.route('/double_star-list/<string:double_star_list_id>/chart-pos-img/<string:ra>/<string:dec>', methods=['GET'])
def double_star_list_chart_pos_img(double_star_list_id, ra, dec):
    ...
    img_bytes = common_chart_pos_img(None, None, ra, dec, visible_objects=visible_objects, highlights_double_star_list=highlights_double_star_list)
...
@main_double_star_list.route('/double_star-list/<string:double_star_list_id>/chart-legend-img/<string:ra>/<string:dec>', methods=['GET'])
...
@main_double_star_list.route('/double_star-list/<string:double_star_list_id>/chart-pdf/<string:ra>/<string:dec>', methods=['GET'])
