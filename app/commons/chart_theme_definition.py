...
class ChartThemeDefinition:
    def __init__(self):
        ...
        self.horizont_color = None
        self.horizont_linewidth = None
    ...
    def validate_set(self, defs, errors=None):
        ...
        self.horizont_color = self._parse_color(defs, 'horizont_color', self.horizont_color, errors)
        self.horizont_linewidth = self._parse_linewidth(defs, 'horizont_linewidth', self.horizont_linewidth, errors)
    ...
    def fill_config(self, config):
        ...
        config.horizont_color = self.horizont_color
        config.horizont_linewidth = self.horizont_linewidth
