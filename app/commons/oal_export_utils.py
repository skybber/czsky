...
from app.commons.openastronomylog import OaldeepSkyGC, OaldeepSkyOC, OaldeepSkyGN, OaldeepSkyDN, OaldeepSkyPN, OaldeepSkyAS
from app.commons.openastronomylog import OaldeepSkyQS
