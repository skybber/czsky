...
FIELD_SIZES = (0.25, 0.5, 1, 2, 5, 10, 20, 40, 100, 180)
...
MAG_SCALES = [(14, 16), (13, 16), (12, 16), (11, 15), (10, 13), (8, 11), (6, 9), (6, 8), (5, 7), (5, 7)]
DSO_MAG_SCALES = [(10, 18), (10, 18), (10, 18), (10, 18), (10, 18), (7, 15), (7, 13), (7, 11), (6, 10), (6, 10)]
...
def _create_dso_highlights(highlights_dso_list, observed_dso_ids, force_light_mode=False):
    ...
    hl2 = fchart3.DsoHighlightDefinition(dashed_highlighted_dsos, line_width+0.1, color, (0.6, 0.8))
    return [hl1, hl2]
